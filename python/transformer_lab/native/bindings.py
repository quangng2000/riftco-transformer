"""Small, dependency-free Python binding for transformer_lab's C ABI."""
...
class TensorLabError(RuntimeError):
    """An error reported by the transformer_lab native library."""
...
def _library_filenames(postfix: str = "") -> tuple[str, ...]:
    if sys.platform == "darwin":
        return (f"libtransformer_lab_c{postfix}.dylib",)
    if os.name == "nt":
        return (
            f"transformer_lab_c{postfix}.dll",
            f"libtransformer_lab_c{postfix}.dll",
        )
    return (f"libtransformer_lab_c{postfix}.so",)
...
def _source_project_root() -> Path | None:
    ...
    if (
        ...
        and (candidate / "include" / "transformer_lab").is_dir()
    ):
        return candidate
    return None
...
def _sanitizers_enabled_for_build(directory: Path) -> bool:
    for candidate in (directory, directory.parent):
        ...
        try:
            ...
            continue
        return (
            "TRANSFORMER_LAB_ENABLE_SANITIZERS:BOOL=ON" in contents
...
def _candidate_libraries() -> list[str]:
    override = os.environ.get("TRANSFORMER_LAB_LIBRARY")
    if override:
    ...
    system_library = ctypes.util.find_library("transformer_lab_c")
    if system_library:
        add(system_library)
    return candidates
...
def _configure_library(library: ctypes.CDLL) -> None:
    library.tl_abi_version.argtypes = []
    library.tl_abi_version.restype = ctypes.c_uint32
    actual_version = int(library.tl_abi_version())
    if not _abi_version_is_compatible(actual_version):
        raise RuntimeError(
            "transformer_lab C ABI mismatch: "
    ...
    library.tl_status_string.argtypes = [ctypes.c_int32]
    library.tl_status_string.restype = ctypes.c_char_p
    library.tl_last_error.argtypes = []
    library.tl_last_error.restype = ctypes.c_char_p

    library.tl_tokenizer_create.argtypes = [
        ctypes.POINTER(ctypes.c_uint8),
        ctypes.c_uint64,
        ctypes.POINTER(_TokenizerHandle),
    ]
    library.tl_tokenizer_create.restype = ctypes.c_int32
    library.tl_tokenizer_options_init.argtypes = [
        ctypes.POINTER(_NativeTokenizerOptions),
        ctypes.c_uint64,
    ]
    library.tl_tokenizer_options_init.restype = ctypes.c_int32
    library.tl_tokenizer_create_with_options.argtypes = [
        ctypes.POINTER(ctypes.c_uint8),
        ctypes.c_uint64,
        ctypes.POINTER(_NativeTokenizerOptions),
        ctypes.POINTER(_TokenizerHandle),
    ]
    library.tl_tokenizer_create_with_options.restype = ctypes.c_int32
    library.tl_tokenizer_create_from_byte_vocabulary.argtypes = [
        ctypes.POINTER(ctypes.c_uint8),
        ctypes.c_uint64,
        ctypes.POINTER(_TokenizerHandle),
    ]
    library.tl_tokenizer_create_from_byte_vocabulary.restype = (
        ctypes.c_int32
    )
    library.tl_tokenizer_create_from_bpe_merges.argtypes = [
        ctypes.POINTER(_NativeBpeMergeRule),
        ctypes.c_uint64,
        ctypes.POINTER(_TokenizerHandle),
    ]
    library.tl_tokenizer_create_from_bpe_merges.restype = ctypes.c_int32
    library.tl_tokenizer_release.argtypes = [_TokenizerHandle]
    library.tl_tokenizer_release.restype = None
    library.tl_tokenizer_get_method.argtypes = [
        _TokenizerHandle,
        ctypes.POINTER(ctypes.c_int32),
    ]
    library.tl_tokenizer_get_method.restype = ctypes.c_int32
    library.tl_tokenizer_vocabulary_size.argtypes = [
        _TokenizerHandle,
        ctypes.POINTER(ctypes.c_uint64),
    ]
    library.tl_tokenizer_vocabulary_size.restype = ctypes.c_int32
    library.tl_tokenizer_bpe_merge_count.argtypes = [
        _TokenizerHandle,
        ctypes.POINTER(ctypes.c_uint64),
    ]
    library.tl_tokenizer_bpe_merge_count.restype = ctypes.c_int32
    library.tl_tokenizer_bpe_merge_rule.argtypes = [
        _TokenizerHandle,
        ctypes.c_uint64,
        ctypes.POINTER(_NativeBpeMergeRule),
    ]
    library.tl_tokenizer_bpe_merge_rule.restype = ctypes.c_int32
    library.tl_tokenizer_vocabulary.argtypes = [
        _TokenizerHandle,
        ctypes.POINTER(ctypes.c_uint8),
        ctypes.c_uint64,
        ctypes.POINTER(ctypes.c_uint64),
    ]
    library.tl_tokenizer_vocabulary.restype = ctypes.c_int32
    library.tl_tokenizer_token_bytes.argtypes = [
        _TokenizerHandle,
        ctypes.c_uint32,
        ctypes.POINTER(ctypes.c_uint8),
        ctypes.c_uint64,
    ...
    library.tl_tokenizer_token_bytes.restype = ctypes.c_int32
    library.tl_tokenizer_encode.argtypes = [
        _TokenizerHandle,
        ctypes.POINTER(ctypes.c_uint8),
        ctypes.c_uint64,
    ...
    library.tl_tokenizer_encode.restype = ctypes.c_int32
    library.tl_tokenizer_decode.argtypes = [
        _TokenizerHandle,
        ctypes.POINTER(ctypes.c_uint32),
        ctypes.c_uint64,
        ctypes.POINTER(ctypes.c_uint8),
    ...
    library.tl_tokenizer_decode.restype = ctypes.c_int32

    library.tl_backend_is_available.argtypes = [
        ctypes.c_int32,
        ctypes.POINTER(ctypes.c_int32),
    ]
    library.tl_backend_is_available.restype = ctypes.c_int32

    library.tl_context_create.argtypes = [
        ctypes.c_int32,
        ctypes.POINTER(_ContextHandle),
    ]
    library.tl_context_create.restype = ctypes.c_int32
    library.tl_context_release.argtypes = [_ContextHandle]
    library.tl_context_release.restype = None
    library.tl_context_backend.argtypes = [
        _ContextHandle,
        ctypes.POINTER(ctypes.c_int32),
    ]
    library.tl_context_backend.restype = ctypes.c_int32

    library.tl_tensor_create_f32.argtypes = [
        _ContextHandle,
        ctypes.POINTER(ctypes.c_uint64),
        ctypes.c_uint64,
    ...
    library.tl_tensor_create_f32.restype = ctypes.c_int32
    library.tl_tensor_zeros_f32.argtypes = [
        _ContextHandle,
        ctypes.POINTER(ctypes.c_uint64),
        ctypes.c_uint64,
        ctypes.POINTER(_TensorHandle),
    ]
    library.tl_tensor_zeros_f32.restype = ctypes.c_int32
    library.tl_tensor_release.argtypes = [_TensorHandle]
    library.tl_tensor_release.restype = None
    library.tl_tensor_backend.argtypes = [
        _TensorHandle,
        ctypes.POINTER(ctypes.c_int32),
    ]
    library.tl_tensor_backend.restype = ctypes.c_int32
    library.tl_tensor_rank.argtypes = [
        _TensorHandle,
        ctypes.POINTER(ctypes.c_uint64),
    ]
    library.tl_tensor_rank.restype = ctypes.c_int32
    library.tl_tensor_shape.argtypes = [
        _TensorHandle,
        ctypes.POINTER(ctypes.c_uint64),
        ctypes.c_uint64,
    ]
    library.tl_tensor_shape.restype = ctypes.c_int32
    library.tl_tensor_numel.argtypes = [
        _TensorHandle,
        ctypes.POINTER(ctypes.c_uint64),
    ]
    library.tl_tensor_numel.restype = ctypes.c_int32
    library.tl_tensor_copy_to_host_f32.argtypes = [
        _TensorHandle,
        ctypes.POINTER(ctypes.c_float),
        ctypes.c_uint64,
    ]
    library.tl_tensor_copy_to_host_f32.restype = ctypes.c_int32
    library.tl_tensor_matmul.argtypes = [
        _TensorHandle,
        _TensorHandle,
        ctypes.POINTER(_TensorHandle),
    ]
    library.tl_tensor_matmul.restype = ctypes.c_int32

    library.tl_transformer_config_init.argtypes = [
        ctypes.POINTER(_NativeTransformerConfig),
        ctypes.c_uint64,
    ]
    library.tl_transformer_config_init.restype = ctypes.c_int32
    library.tl_decode_session_options_init.argtypes = [
        ctypes.POINTER(_NativeDecodeSessionOptions),
        ctypes.c_uint64,
    ]
    library.tl_decode_session_options_init.restype = ctypes.c_int32
    library.tl_model_create.argtypes = [
        ctypes.POINTER(_NativeTransformerConfig),
        ctypes.POINTER(_ModelHandle),
    ]
    library.tl_model_create.restype = ctypes.c_int32
    library.tl_model_release.argtypes = [_ModelHandle]
    library.tl_model_release.restype = None
    library.tl_model_to.argtypes = [
        _ModelHandle,
        ctypes.c_int32,
    ]
    library.tl_model_to.restype = ctypes.c_int32
    library.tl_model_backend.argtypes = [
        _ModelHandle,
        ctypes.POINTER(ctypes.c_int32),
    ]
    library.tl_model_backend.restype = ctypes.c_int32
    library.tl_model_set_full_sequence_attention.argtypes = [
        _ModelHandle,
        ctypes.c_int32,
    ]
    library.tl_model_set_full_sequence_attention.restype = ctypes.c_int32
    library.tl_model_full_sequence_attention.argtypes = [
        _ModelHandle,
        ctypes.POINTER(ctypes.c_int32),
    ]
    library.tl_model_full_sequence_attention.restype = ctypes.c_int32
    library.tl_model_set_activation_checkpointing.argtypes = [
        _ModelHandle,
        ctypes.c_int32,
    ]
    library.tl_model_set_activation_checkpointing.restype = ctypes.c_int32
    library.tl_model_activation_checkpointing.argtypes = [
        _ModelHandle,
        ctypes.POINTER(ctypes.c_int32),
    ]
    library.tl_model_activation_checkpointing.restype = ctypes.c_int32
    library.tl_lora_config_init.argtypes = [
        ctypes.POINTER(_NativeLoraConfig),
        ctypes.c_uint64,
    ]
    library.tl_lora_config_init.restype = ctypes.c_int32
    library.tl_model_attach_lora.argtypes = [
        _ModelHandle,
        ctypes.POINTER(_NativeLoraConfig),
    ]
    library.tl_model_attach_lora.restype = ctypes.c_int32
    library.tl_model_has_lora.argtypes = [
        _ModelHandle,
        ctypes.POINTER(ctypes.c_int32),
    ]
    library.tl_model_has_lora.restype = ctypes.c_int32
    library.tl_model_lora_config.argtypes = [
        _ModelHandle,
        ctypes.POINTER(_NativeLoraConfig),
    ]
    library.tl_model_lora_config.restype = ctypes.c_int32
    library.tl_model_forward.argtypes = [
        _ModelHandle,
        ctypes.POINTER(ctypes.c_uint32),
        ctypes.c_uint64,
        ctypes.c_uint64,
    ...
    library.tl_model_forward.restype = ctypes.c_int32
    library.tl_model_decode_session_create.argtypes = [
        _ModelHandle,
        ctypes.POINTER(_NativeDecodeSessionOptions),
        ctypes.POINTER(_DecodeSessionHandle),
    ]
    library.tl_model_decode_session_create.restype = ctypes.c_int32
    library.tl_decode_session_release.argtypes = [_DecodeSessionHandle]
    library.tl_decode_session_release.restype = None
    library.tl_decode_session_reset.argtypes = [_DecodeSessionHandle]
    library.tl_decode_session_reset.restype = ctypes.c_int32
    library.tl_decode_session_size.argtypes = [
        _DecodeSessionHandle,
        ctypes.POINTER(ctypes.c_uint64),
    ]
    library.tl_decode_session_size.restype = ctypes.c_int32
    library.tl_decode_session_capacity.argtypes = [
        _DecodeSessionHandle,
        ctypes.POINTER(ctypes.c_uint64),
    ]
    library.tl_decode_session_capacity.restype = ctypes.c_int32
    library.tl_decode_session_cache_kind.argtypes = [
        _DecodeSessionHandle,
        ctypes.POINTER(ctypes.c_int32),
    ]
    library.tl_decode_session_cache_kind.restype = ctypes.c_int32
    library.tl_decode_session_block_size.argtypes = [
        _DecodeSessionHandle,
        ctypes.POINTER(ctypes.c_uint64),
    ]
    library.tl_decode_session_block_size.restype = ctypes.c_int32
    library.tl_decode_session_step.argtypes = [
        _DecodeSessionHandle,
        ctypes.c_uint32,
        ctypes.POINTER(ctypes.c_float),
        ctypes.c_uint64,
    ...
    library.tl_decode_session_step.restype = ctypes.c_int32
    library.tl_model_parameters.argtypes = [
        _ModelHandle,
        ctypes.POINTER(_ParameterListHandle),
    ]
    library.tl_model_parameters.restype = ctypes.c_int32
    library.tl_model_lora_parameters.argtypes = [
        _ModelHandle,
        ctypes.POINTER(_ParameterListHandle),
    ]
    library.tl_model_lora_parameters.restype = ctypes.c_int32
    library.tl_model_merge_lora.argtypes = [_ModelHandle]
    library.tl_model_merge_lora.restype = ctypes.c_int32

    library.tl_parameter_list_release.argtypes = [
        _ParameterListHandle,
    ]
    library.tl_parameter_list_release.restype = None
    library.tl_parameter_list_count.argtypes = [
        _ParameterListHandle,
        ctypes.POINTER(ctypes.c_uint64),
    ]
    library.tl_parameter_list_count.restype = ctypes.c_int32
    library.tl_parameter_list_backend.argtypes = [
        _ParameterListHandle,
        ctypes.POINTER(ctypes.c_int32),
    ]
    library.tl_parameter_list_backend.restype = ctypes.c_int32
    library.tl_parameter_list_name.argtypes = [
        _ParameterListHandle,
        ctypes.c_uint64,
    ...
    library.tl_parameter_list_name.restype = ctypes.c_int32
    library.tl_parameter_list_rank.argtypes = [
        _ParameterListHandle,
        ctypes.c_uint64,
        ctypes.POINTER(ctypes.c_uint64),
    ]
    library.tl_parameter_list_rank.restype = ctypes.c_int32
    library.tl_parameter_list_shape.argtypes = [
        _ParameterListHandle,
        ctypes.c_uint64,
        ctypes.POINTER(ctypes.c_uint64),
        ctypes.c_uint64,
    ]
    library.tl_parameter_list_shape.restype = ctypes.c_int32
    library.tl_parameter_list_numel.argtypes = [
        _ParameterListHandle,
        ctypes.c_uint64,
        ctypes.POINTER(ctypes.c_uint64),
    ]
    library.tl_parameter_list_numel.restype = ctypes.c_int32
    library.tl_parameter_list_total_numel.argtypes = [
        _ParameterListHandle,
        ctypes.POINTER(ctypes.c_uint64),
    ]
    library.tl_parameter_list_total_numel.restype = ctypes.c_int32
    library.tl_parameter_list_copy_to_host_f32.argtypes = [
        _ParameterListHandle,
        ctypes.POINTER(ctypes.c_float),
        ctypes.c_uint64,
    ]
    library.tl_parameter_list_copy_to_host_f32.restype = ctypes.c_int32
    library.tl_parameter_list_load_from_host_f32.argtypes = [
        _ParameterListHandle,
        ctypes.POINTER(ctypes.c_float),
        ctypes.c_uint64,
    ]
    library.tl_parameter_list_load_from_host_f32.restype = ctypes.c_int32

    library.tl_variable_release.argtypes = [_VariableHandle]
    library.tl_variable_release.restype = None
    library.tl_variable_backend.argtypes = [
        _VariableHandle,
        ctypes.POINTER(ctypes.c_int32),
    ]
    library.tl_variable_backend.restype = ctypes.c_int32
    library.tl_variable_rank.argtypes = [
        _VariableHandle,
        ctypes.POINTER(ctypes.c_uint64),
    ]
    library.tl_variable_rank.restype = ctypes.c_int32
    library.tl_variable_shape.argtypes = [
        _VariableHandle,
        ctypes.POINTER(ctypes.c_uint64),
        ctypes.c_uint64,
    ]
    library.tl_variable_shape.restype = ctypes.c_int32
    library.tl_variable_numel.argtypes = [
        _VariableHandle,
        ctypes.POINTER(ctypes.c_uint64),
    ]
    library.tl_variable_numel.restype = ctypes.c_int32
    library.tl_variable_copy_to_host_f32.argtypes = [
        _VariableHandle,
        ctypes.POINTER(ctypes.c_float),
        ctypes.c_uint64,
    ]
    library.tl_variable_copy_to_host_f32.restype = ctypes.c_int32
    library.tl_variable_backward.argtypes = [_VariableHandle]
    library.tl_variable_backward.restype = ctypes.c_int32
    library.tl_cross_entropy.argtypes = [
        _VariableHandle,
        ctypes.POINTER(ctypes.c_uint32),
        ctypes.c_uint64,
        ctypes.POINTER(_VariableHandle),
    ]
    library.tl_cross_entropy.restype = ctypes.c_int32

    library.tl_adam_options_init.argtypes = [
        ctypes.POINTER(_NativeAdamOptions),
        ctypes.c_uint64,
    ]
    library.tl_adam_options_init.restype = ctypes.c_int32
    library.tl_adam_create.argtypes = [
        _ParameterListHandle,
        ctypes.POINTER(_NativeAdamOptions),
        ctypes.POINTER(_AdamHandle),
    ]
    library.tl_adam_create.restype = ctypes.c_int32
    library.tl_adam_release.argtypes = [_AdamHandle]
    library.tl_adam_release.restype = None
    library.tl_adam_backend.argtypes = [
        _AdamHandle,
        ctypes.POINTER(ctypes.c_int32),
    ]
    library.tl_adam_backend.restype = ctypes.c_int32
    library.tl_adam_step_count.argtypes = [
        _AdamHandle,
        ctypes.POINTER(ctypes.c_uint64),
    ]
    library.tl_adam_step_count.restype = ctypes.c_int32
    library.tl_adam_parameter_count.argtypes = [
        _AdamHandle,
        ctypes.POINTER(ctypes.c_uint64),
    ]
    library.tl_adam_parameter_count.restype = ctypes.c_int32
    library.tl_adam_step.argtypes = [
        _AdamHandle,
        ctypes.POINTER(_NativeAdamStepStats),
    ]
    library.tl_adam_step.restype = ctypes.c_int32
    library.tl_adam_zero_gradients.argtypes = [_AdamHandle]
    library.tl_adam_zero_gradients.restype = ctypes.c_int32
...
def _load_library() -> ctypes.CDLL:
    ...
    guidance = (
        "could not load libtransformer_lab_c; set "
        "TRANSFORMER_LAB_LIBRARY to the shared-library path"
    )
    if failures:
        guidance += "\n" + "\n".join(failures)
...
def _check(status: int) -> None:
    ...
    detail = _decode(library.tl_last_error())
    status_name = _decode(library.tl_status_string(status))
    raise TensorLabError(int(status), status_name, detail)
...
def backend_available(backend: str | int) -> bool:
    ...
    _check(
        _native().tl_backend_is_available(
...
class Tokenizer:
    ...
    def __init__(
        ...
        *,
        ...
        _check(
            _native().tl_tokenizer_options_init(
        ...
        _check(
            _native().tl_tokenizer_create_with_options(
                native_corpus,
                len(corpus_bytes),
                ctypes.byref(options),
                ctypes.byref(output),
    ...
    def from_state(
        ...
        *,
        ...
        if method_code == TOKENIZER_METHOD_BYTE:
            ...
            _check(
                _native().tl_tokenizer_create_from_byte_vocabulary(
                    native_vocabulary,
                    len(vocabulary),
                    ctypes.byref(output),
                )
            ...
            _check(
                _native().tl_tokenizer_create_from_bpe_merges(
                    native_rules,
                    len(checked_rules),
                    ctypes.byref(output),
                )
    ...
    def vocab_size(self) -> int:
        with self._lock:
            ...
            _check(
                _native().tl_tokenizer_vocabulary_size(
                    self._native_handle(),
                    ctypes.byref(output),
                )
            )
    ...
    def method(self) -> str:
        with self._lock:
            ...
            _check(
                _native().tl_tokenizer_get_method(
                    self._native_handle(),
                    ctypes.byref(output),
                )
            )
    ...
    def _token_bytes(self, token: int) -> bytes:
        required = ctypes.c_uint64()
        _check(
            _native().tl_tokenizer_token_bytes(
                self._native_handle(),
                token,
                None,
                0,
    ...
    def merge_rules(self) -> tuple[tuple[int, int, int], ...]:
        ...
        with self._lock:
            ...
            _check(
                _native().tl_tokenizer_bpe_merge_count(
                    self._native_handle(),
                    ctypes.byref(count),
                )
            )
            ...
            for index in range(int(count.value)):
                ...
                _check(
                    _native().tl_tokenizer_bpe_merge_rule(
                        self._native_handle(),
                        index,
                        ctypes.byref(rule),
                    )
    ...
    def vocabulary_bytes(self) -> bytes:
        with self._lock:
            ...
            required = ctypes.c_uint64()
            _check(
                _native().tl_tokenizer_vocabulary(
                    self._native_handle(),
                    None,
                    0,
                    ctypes.byref(required),
    ...
    def close(self) -> None:
        with self._lock:
            ...
            if handle is None:
                return
            self._handle = None
            _native().tl_tokenizer_release(handle)
    ...
    def close(self) -> None:
        with self._lock:
            ...
            if handle is None:
                return
            self._handle = None
            _native().tl_context_release(handle)
...
class Tensor:
    ...
    def _from_native(
        ...
        try:
            ...
            _native().tl_tensor_release(handle)
            raise
    ...
    def tolist(self) -> list[float]:
        with self._lock:
            ...
            output = array_type()
            _check(
                _native().tl_tensor_copy_to_host_f32(
                    self._native_handle(),
                    output,
                    count,
                )
...
class DecoderOnlyTransformer:
    ...
    def __init__(
        ...
        *,
        ...
        _check(
            _native().tl_transformer_config_init(
        ...
        try:
            _check(
                _native().tl_model_set_full_sequence_attention(
                    output,
                    attention_code,
                )
            )
            _check(
                _native().tl_model_set_activation_checkpointing(
                    output,
                    activation_checkpointing_code,
                )
            )
        except BaseException:
            _native().tl_model_release(output)
            raise
        self._config = config
        self._handle = output
    ...
    def full_sequence_attention(self) -> str:
        with self._lock:
            output = ctypes.c_int32()
            _check(
                _native().tl_model_full_sequence_attention(
                    self._native_handle(),
                    ctypes.byref(output),
                )
            )
    ...
    def activation_checkpointing(self) -> str:
        with self._lock:
            output = ctypes.c_int32()
            _check(
                _native().tl_model_activation_checkpointing(
                    self._native_handle(),
                    ctypes.byref(output),
                )
            )
    ...
    def adapter_parameters(self) -> ParameterList:
        ...
        with self._lock:
            output = _ParameterListHandle()
            _check(
                _native().tl_model_lora_parameters(
                    self._native_handle(),
                    ctypes.byref(output),
                )
            )
    ...
    def decode_session(
        ...
        *,
        ...
        _check(
            _native().tl_decode_session_options_init(
                ctypes.byref(options),
                ctypes.sizeof(options),
            )
        )
        ...
        with self._lock:
            ...
            _check(
                _native().tl_model_decode_session_create(
                    self._native_handle(),
                    ctypes.byref(options),
                    ctypes.byref(output),
                )
    ...
    def close(self) -> None:
        with self._lock:
            ...
            if handle is None:
                return
            self._handle = None
            _native().tl_model_release(handle)
...
class DecodeSession:
    ...
    def _from_native(
        ...
        try:
            ...
            _native().tl_decode_session_release(handle)
            raise
    ...
    def size(self) -> int:
        with self._lock:
            output = ctypes.c_uint64()
            _check(
                _native().tl_decode_session_size(
                    self._native_handle(),
                    ctypes.byref(output),
                )
            )
    ...
    def capacity(self) -> int:
        with self._lock:
            output = ctypes.c_uint64()
            _check(
                _native().tl_decode_session_capacity(
                    self._native_handle(),
                    ctypes.byref(output),
                )
            )
    ...
    def cache(self) -> str:
        with self._lock:
            output = ctypes.c_int32()
            _check(
                _native().tl_decode_session_cache_kind(
                    self._native_handle(),
                    ctypes.byref(output),
                )
            )
    ...
    def block_size(self) -> int:
        with self._lock:
            output = ctypes.c_uint64()
            _check(
                _native().tl_decode_session_block_size(
                    self._native_handle(),
                    ctypes.byref(output),
                )
            )
    ...
    def reset(self) -> None:
        with self._lock:
            _check(
                _native().tl_decode_session_reset(
                    self._native_handle()
                )
            )
    ...
    def step(self, token: object) -> tuple[float, ...]:
        ...
        with self._lock:
            ...
            required = ctypes.c_uint64()
            _check(
                _native().tl_decode_session_step(
                    self._native_handle(),
                    token_id,
                    output,
                    count,
...
class ParameterList:
    ...
    def _from_native(
        ...
        try:
            ...
            _native().tl_parameter_list_release(handle)
            raise
    ...
    def __len__(self) -> int:
        with self._lock:
            output = ctypes.c_uint64()
            _check(
                _native().tl_parameter_list_count(
                    self._native_handle(),
                    ctypes.byref(output),
                )
            )
    ...
    def backend(self) -> str:
        with self._lock:
            output = ctypes.c_int32()
            _check(
                _native().tl_parameter_list_backend(
                    self._native_handle(),
                    ctypes.byref(output),
                )
            )
    ...
    def names(self) -> tuple[str, ...]:
        with self._lock:
            ...
            for index in range(len(self)):
                required = ctypes.c_uint64()
                _check(
                    _native().tl_parameter_list_name(
                        self._native_handle(),
                        index,
                        None,
                        0,
    ...
    def shapes(self) -> tuple[tuple[int, ...], ...]:
        ...
        with self._lock:
            ...
            for index in range(len(self)):
                rank = ctypes.c_uint64()
                _check(
                    _native().tl_parameter_list_rank(
                        self._native_handle(),
                        index,
                        ctypes.byref(rank),
                    )
                ...
                if native_rank == 0:
                    _check(
                        _native().tl_parameter_list_shape(
                            self._native_handle(),
                            index,
                            None,
                            0,
    ...
    def total_numel(self) -> int:
        with self._lock:
            output = ctypes.c_uint64()
            _check(
                _native().tl_parameter_list_total_numel(
                    self._native_handle(),
                    ctypes.byref(output),
                )
            )
    ...
    def flat_values(self) -> tuple[float, ...]:
        ...
        with self._lock:
            ...
            _check(
                _native().tl_parameter_list_copy_to_host_f32(
                    self._native_handle(),
                    output,
                    count,
                )
    ...
    def load_flat_values(self, values: Iterable[object]) -> None:
        ...
        with self._lock:
            ...
            _check(
                _native().tl_parameter_list_load_from_host_f32(
                    self._native_handle(),
                    native_values,
                    len(converted),
                )
...
class Variable:
    ...
    def _from_native(
        ...
        try:
            ...
            _native().tl_variable_release(handle)
            raise
    ...
    def tolist(self) -> list[float]:
        with self._lock:
            ...
            output = array_type()
            _check(
                _native().tl_variable_copy_to_host_f32(
                    self._native_handle(),
                    output,
                    count,
                )
...
class Adam:
    ...
    def parameter_count(self) -> int:
        with self._lock:
            output = ctypes.c_uint64()
            _check(
                _native().tl_adam_parameter_count(
                    self._native_handle(),
                    ctypes.byref(output),
                )
            )
    ...
    def zero_gradients(self) -> None:
        with self._lock:
            _check(
                _native().tl_adam_zero_gradients(
                    self._native_handle()
                )
            )
    ...
    def close(self) -> None:
        with self._lock:
            ...
            if handle is None:
                return
            self._handle = None
            _native().tl_adam_release(handle)
