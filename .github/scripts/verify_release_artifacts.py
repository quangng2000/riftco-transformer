...
def verify_sdist(
    ...
    required_suffixes = {
        ...
        "/src/c_api/abi.cpp",
        "/src/c_api/adam.cpp",
        "/src/c_api/autograd.cpp",
        "/src/c_api/bridge.cpp",
        "/src/c_api/context_tensor.cpp",
        "/src/c_api/decode_session.cpp",
        "/src/c_api/error.cpp",
        "/src/c_api/internal/bridge.hpp",
        "/src/c_api/internal/error.hpp",
        "/src/c_api/internal/handles.hpp",
        "/src/c_api/internal/model_state.hpp",
        "/src/c_api/llama_mistral.cpp",
        "/src/c_api/model.cpp",
        "/src/c_api/model_state.cpp",
        "/src/c_api/parameters.cpp",
        "/src/c_api/programmed.cpp",
        "/src/c_api/tokenizer.cpp",
